# URLs oficiais — Microsoft Learn (WPF/XAML + XML + C#/.NET)
...
## C# — linguagem (code-behind do WPF)

- Guia do C#: <https://learn.microsoft.com/pt-br/dotnet/csharp/>
- Tour do C#: <https://learn.microsoft.com/pt-br/dotnet/csharp/tour-of-csharp/overview>
- Sistema de tipos: <https://learn.microsoft.com/pt-br/dotnet/csharp/fundamentals/types/>
- POO (classes, structs, heranca): <https://learn.microsoft.com/pt-br/dotnet/csharp/fundamentals/object-oriented/>
- Excecoes (try/catch/throw): <https://learn.microsoft.com/pt-br/dotnet/csharp/fundamentals/exceptions/>
- Programacao assincrona (async/await): <https://learn.microsoft.com/pt-br/dotnet/csharp/asynchronous-programming/>
- Referencia da linguagem: <https://learn.microsoft.com/pt-br/dotnet/csharp/language-reference/>
- Palavras-chave: <https://learn.microsoft.com/pt-br/dotnet/csharp/language-reference/keywords/>

## .NET — fundamentos e API (runtime, eventos, excecoes)

- Fundamentos do .NET: <https://learn.microsoft.com/pt-br/dotnet/fundamentals/>
- Referencia da API .NET (navegador): <https://learn.microsoft.com/pt-br/dotnet/api/>
- Eventos .NET (raise/consume): <https://learn.microsoft.com/pt-br/dotnet/standard/events/>
- Boas praticas de excecoes: <https://learn.microsoft.com/pt-br/dotnet/standard/exceptions/best-practices-for-exceptions/>

## WPF — code-behind (Dispatcher, eventos roteados)

- DispatcherTimer (timer na thread de UI): <https://learn.microsoft.com/pt-br/dotnet/api/system.windows.threading.dispatchertimer/>
- Visao geral de eventos roteados: <https://learn.microsoft.com/pt-br/dotnet/desktop/wpf/events/routed-events-overview>

## Padrao de URL da referencia de API

- Formato: `https://learn.microsoft.com/pt-br/dotnet/api/<namespace>.<tipo>/` em minusculas,
  ex.: `.../dotnet/api/system.windows.media.rotatetransform/`.
- Se a pagina pt-br estiver vazia, troque para `en-us`.
