---
description: Rules da skill msdocs-wpf-xml — consultar Learn via fetch-docs-microsoft (allowlist learn.microsoft.com, pt-br com fallback en-us). Aplica-se a WPF/XAML/XML e C#/.NET no PI_T1.
---
...
1. Para qualquer API WPF/XAML/XML ou C#/.NET, consulte o Learn via `fetch-docs-microsoft` antes de responder; cite a URL.
