...
├── App.xaml                   # Definição do aplicativo WPF
├── App.xaml.cs                # Code-behind do ciclo de vida da aplicação
├── MainWindow.xaml            # Interface gráfica, geometrias (0,0), RodaTemplate e Storyboard
├── MainWindow.xaml.cs         # Cinemática analítica por quadro (CompositionTarget.Rendering)
